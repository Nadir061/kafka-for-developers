 ...
 */
public class KafkaConfig07 {

    /** Топик для Person c четным возрастом */
    public static final String INPUT_EVEN_AGE_TOPIC = "w06-topic-out-even-age";

    /** Топик для Person c нечетным возрастом */
    public static final String INPUT_ODD_AGE_TOPIC = "w06-topic-out-odd-age";

    public static final String OUTPUT_TOPIC = "w06-global-k-table";

    private KafkaConfig07() {
    }
